            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Keep space! 👋</div>
                        <span class="text-muted-color font-medium">!سجل دخولك</span>
                    </div>

                    <form @submit.prevent="login">
                        <label for="email1" class="block text-right text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">إسم المستخدم</label>
                        <InputText id="email1" type="text" placeholder="إسم المستخدم" class="w-full md:w-[30rem] mb-8" v-model="username" />

                        <label for="password1" class="block text-right text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">كلمة المرور</label>
                        <Password
                            style="
                                ::placeholder {
                                    text-align: right;
